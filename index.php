...
<meta name="KeyWords" content="14ちゃんねる, 掲示板, 14ch, BBS, 14チャンネル, 14chBBS, 14CH, 14ちゃんねる, Nch, Nチャンネル, Nちゃんねる, NCH, NchBBS">
<meta name="Author" content="nennneko5787">

<title>14ちゃんねる掲示板へようこそ</title>
<style type="text/css">
...
<a href="./14ch.html"><img src="14ch_logo.png" width="151" height="40" alt="14ちゃんねる" align="middle" border="0"></a><a href="./14ch.html">掲示板</a>｜<a href="./sp.php">スマホ版</a>｜<a href="./old__index.html">前のindex</a>｜<a href="./old_index.html">前の前のindex.html</a><!--｜

<div style="display: inline; margin-left: 2.0em;"><form method="GET" action="https://find.3chan.jp/search" accept-charset="UTF-8" style="display: inline;"><input type="text" name="q" style="width: 16em; height: 21.5px;"><button type="submit">スレタイ検索</button></form>
...
<div id="footer_menu">
<div class="guide">
<a href="./test/read.cgi/admin/1651469945">14ちゃんねるからのお知らせ</a>｜<a href="./April-gum/">エイプリルガム</a>

</div>

<div align="center">
  14ちゃんねる掲示板のご利用は利用者各位のご判断にお任せしています。
<div><font color="#666666" size="1">
14ちゃんねるに関してのお問い合わせは <a href="mailto:14ch@f5.si">こちら</a>へどうぞ。
</font></div> 
  <p><font size="1">14ちゃんねる掲示板のデータの利用に関して、原則的に自由ですが、14ちゃんねるの書き込みなどを利用して<!--対価を取る-->収益を得る行為をするときは<!--は--><!--ご遠慮下さい。-->どこかにスレのURLを張ってください。<br>
    <br>
    要するに、14ちゃんねるの書き込みを転載してお金儲けをしているような<!--をモニターして、お金をとってるマーケティング会社の-->Youtubeまとめの方は<br>
    <!--コンテンツの使用許諾を得<!--ご相談頂け-->概要欄か動画のどこかにスレッドのURLを張らないと面倒なことになるかもしれません、、、ってことです。</font></p>
</div>

</div></div>
<p>index.php(開発中...) <!--ver -->nennneko5787＠どうやら管理人 ★</p>
...
<a href="https://www.kooss.com/"><img src="koossbn20.gif"><br>無料情報が沢山あります。</img></a>
</body></html>
